...
export const Footer = () => <div className='footer' id='Contacts'>
	...
	<div className='footer__massenger'>
		...
		<div>
			...
			<div className='footer__massenger-svg_massenger'>
				...
				<a href='https://www.facebook.com/profile.php?id=100014832395332&mibextid=LQQJ4d' target='_blank' rel='noreferrer'>
					<FB />
				</a>
				<a href='https://www.tiktok.com/@nika.aerial.pole?_t=8aFCg3X0ko1&_r=1' target='_blank' rel='noreferrer'>
					<TikTok />
				</a>
			</div>
		</div>
		<a href='https://instagram.com/ruslan_ray_?igshid=ZjE2NGZiNDQ=' target='_blank' rel='noreferrer'>
